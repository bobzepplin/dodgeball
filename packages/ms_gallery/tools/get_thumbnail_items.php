...
defined('C5_EXECUTE') or die(_("Access Denied."));
	...
	Loader::model('block');
	$block = new BlockRecord('btMsGallery');
	...
	if ($block && $block->fsID == $fsID) {
		...
		$images = MsGallery::getUnsortedPermittedFilesetImages($fsID);
	}
	
	//Render the images
	Loader::packageElement('thumbnail_items', 'ms_gallery', array('images' => $images));
