...
?>
	...
	<?php  foreach ($pages as $page):
		...
		$type = $page->getAttribute('equipetype');
		$victoire = $page->getAttribute('victoires');
		$provenance = $page->getAttribute('provenance');
		...
		<div class="in_actu">
			...
			<div class="right_in_actu">
				<h3><?php  echo $title ?></h3>
				 <hr />
				<p>Type d'équipe: <?php echo $type ?><br>Victoire(s): <?php echo $victoire ?><br>Provenance: <?php echo $provenance ?></p>
