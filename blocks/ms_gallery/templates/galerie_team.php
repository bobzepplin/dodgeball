...
<?php  foreach ($images as $img){
	...
	$Names = $f->getAttribute('name_vorname');
	$function = $f->getAttribute('function');
	$emailsrc = $f->getAttribute('email');
  	$email = '<a href="mailto:'.$emailsrc.'">'.$emailsrc.'</a>';
?>
