...
$bodyHTML .= '<tr><td bgcolor="#222222"><a href="http://www.dodgeball.ch"><img src="'.BASE_URL.'/application/themes/afdbba/dist/img/mail/header.jpg" width="480" height="297" alt="Dodgeball Beach Tournament" border="0" style="display:block"/></a></td></tr>'."\n";
$bodyHTML .= '<tr><td>&nbsp;</td></tr><tr><td colspan="2">'."\n";
$bodyHTML .= '<tr><td>'."\n";


$bodyHTML .= '<tr><td width="300"><h1 style="font-weight: lighter;">Inscription au tournoi</h1></td></tr>'."\n";
...
$bodyHTML .= '<tr><td>&nbsp;</td></tr>'."\n";
$bodyHTML .= '<tr><td>Pour voir l\'integralité du formulaire, cliquez ci-dessous:</td></tr>'."\n";
$bodyHTML .= '<tr><td><a href="'.$formDisplayUrl.'">'.$formDisplayUrl.'</a></td></tr>'."\n";
