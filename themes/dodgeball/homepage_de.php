                    ...
                    <div id="featured">
                        <div class="slide" style="background: url('<?= $this->getThemePath() ?>/img/template/slider_image2.jpg') no-repeat; background-size:100%;">
                            <div class="slider_right">
                                <span>Am 20. Juni in Portalban am Strand</span>
                                <h2>DODGEBALL BEACH TOURNAMENT 2015</h2>
                                <p>Fordern Sie Ihre Freunde in einem einzartigen VölkerballWettkampf !</p>
                                <div class="bt-container">
                                    <a class="bt-noir" href="<?php echo DIR_REL?>/de/das-turnier/2014-ausgabe/">Mehr Infos</a>
                                    <a class="bt-orange fancy" data-fancybox-type="iframe" href="<?php echo DIR_REL?>/de/turnier-registrierung">Jetzt anmelden!</a>
                                </div>
                            </div>
                        </div>
                </div>
