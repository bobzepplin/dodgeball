...
var randomcomment = Math.floor((Math.random()*3)+1-1);
    ...
    $( "#CommentZone" ).load( CCM_BASE_URL + "/fr/le-tournoi/vos-commentaires/ .guestBook-entry:lt(3):eq("+randomcomment+")", function() {
        $("<a href='"+CCM_BASE_URL + "/fr/le-tournoi/vos-commentaires/"+"' class='comment_link'>Voir tous les commentaires</a>").appendTo( "#CommentZone" );
});
